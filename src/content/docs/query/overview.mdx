...
import heroDark from '../../../assets/query-overview-hero.webp';
import heroLight from '../../../assets/query-overview-hero-light.webp';

<Image src={heroDark}  alt="A search bar parses into an abstract syntax tree that fans out into SQL, JSON, and Go predicate targets." class="hero-dark" />
<Image src={heroLight} alt="A search bar parses into an abstract syntax tree that fans out into SQL, JSON, and Go predicate targets." class="hero-light" />
